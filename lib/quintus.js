  ...
  */
  Q.setup = function(id, options) {
    ...
    if(options.scaleToFit) {
     ...
     console.log('Q.el.width:' + Q.el.width);
     console.log('Q.el.height' + Q.el.height);
    ...
    window.addEventListener('webkitfullscreenchange mozfullscreenchange fullscreenchange',function() {
      setTimeout(function() { window.scrollTo(0,1); }, 0);
      console('maximiza pantalla');
    });
